...
<script>
  ...
  import SpecialJobStatistics from './SpecialJobStatistics'
  ...
  export default {
    ...
    methods: {
      ...
      refreshCarouselHeight() {
        ...
        this.carouselHeight = `${document.documentElement.clientHeight - top - 60}px`
      ...
      exitFullscreen() {
        if (!screenfull.isFullscreen)
          this.$router.replace({ name: 'carousel' })
      }
    },
