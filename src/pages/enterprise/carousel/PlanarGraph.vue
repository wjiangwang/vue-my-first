<template>
  <!-- <div class="dashboard-carousel-item-content planar-graph"> -->
  <div class="carousel-item-content planar-graph">
    <div class="sketch-wrapper">
      <risk-sketch
        ...
        class="graph-sketch" :is-carousel="isCarousel"/>
    </div>
  </div>
</template>
