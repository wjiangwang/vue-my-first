...
const tableColumns = [
  { title: '名称', name: 'disposalCardName' },
  { title: '编号', name: 'disposalCardCode' },
  { title: '编制日期', name: 'createDate', type: 'date' },
  { title: '主要负责人', name: 'mainHead' },
  { title: '主要负责人电话', name: 'mainHeadPhone' },
...
export default {
  ...
  created () {
    this.setListParams({ riskAssessmentId: this.$route.params.id })
