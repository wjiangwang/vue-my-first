<template>
  <div
    ...
    <img v-if="status === 1" src="@/assets/icons/abnormal.png" class="img-abnormal">
    <img src="@/assets/icons/monitor.png" v-if="equipmentType === 1" class="img-equipment">
    <img src="@/assets/icons/thermometer.png" v-if="equipmentType === 2" class="img-equipment">
    <img src="@/assets/icons/current_voltage.png" v-if="equipmentType === 3" class="img-equipment">
    <slot></slot>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      handleUp(e) {
        ...
        if (this.parentH * this.heightPercent > 5100 || this.parentW * this.widthPercent > 5000
          || this.width > 50 || this.height > 51) {
          //考虑是图标，不能显示的很大 故增加该判断确保不会有太大变化
          this.widthPercent = 50 / this.parentW * 100
          this.heightPercent = 51 / this.parentH * 100
