  ...
  <div class="risk-sketch"
    ...
    <div class="graph" :style="graphStyle" v-drag>
      ...
      <div class="risk-markups" v-if="imageUrl && imageLoaded">
        ...
        <monitor-risk-markup v-for="(markup, index) in monitorMarkups"
          :key="markup.id.toString() + index"
          v-bind="markup"
          :readonly="readonly"
...
<script>
  ...
  import RiskMarkup from '@/components/RiskMarkup'
  import MonitorRiskMarkup from './MonitorRiskMarkup'
  import GraphTagging from '@/components/GraphTagging'

  export default {
    name: 'MonitorRiskSketch',
