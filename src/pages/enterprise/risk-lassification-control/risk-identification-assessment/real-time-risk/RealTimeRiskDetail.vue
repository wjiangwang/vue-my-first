<template>
  <div class="page risk-assessment-items">
      ...
      <div class="content-box">
        ...
        <div class="el-card is-never-shadow" v-loading="thirdList.loading">
          ...
          >
            ...
            <template slot="level" slot-scope="{ row }">{{riskLevelText(row.riskLevel)}}</template>
            <template slot="risk-assessment-r" slot-scope="{ row }">
              {{row.riskAssessmentR}}
              <span
                v-if="row.minimumL < row.riskAssessmentL"
                style="color: #fa5878;"
              >↑</span>
            </template>
            ...
            <div slot="actions" slot-scope="{ row }" class="table-actions">
              ...
              <el-button
                ...
                v-else
                size="medium"
                @click.stop="thirdItemStandardDetail.show(row.id)"
              >详情</el-button>
              <!-- <el-button type="text"
                size="medium"
    ...
    <real-time-risk-assessment-second-item-form
      ref="secondItemForm"
      :risk-id="riskId"
      :type="$route.query.type"
    ></real-time-risk-assessment-second-item-form>

    <real-time-risk-assessment-third-item-form
      ref="thirdItemForm"
      :second-item-id="currentSecondItem.id"
      :type="$route.query.type"
    ></real-time-risk-assessment-third-item-form>

    <real-time-risk-assessment-third-item-detail
      ref="thirdItemDetail"
      :second-item-id="currentSecondItem.id"
    ></real-time-risk-assessment-third-item-detail>

    <real-time-risk-assessment-third-item-standard-detail
      ref="thirdItemStandardDetail"
      :second-item-id="currentSecondItem.id"
    ></real-time-risk-assessment-third-item-standard-detail>

    <real-time-risk-third-item-case-form
      ref="thirdItemCaseForm"
      :can-edit="canEdit"
...
import RealTimeRiskAssessmentSecondItemForm from './RealTimeRiskAssessmentSecondItemForm'
import RealTimeRiskAssessmentThirdItemForm from './RealTimeRiskAssessmentThirdItemForm'
import RealTimeRiskAssessmentThirdItemDetail from './RealTimeRiskAssessmentThirdItemDetail'
import RealTimeRiskAssessmentThirdItemStandardDetail from './RealTimeRiskAssessmentThirdItemStandardDetail'
import RealTimeRiskThirdItemCaseForm from './RealTimeRiskThirdItemCaseForm'
...
const thirdLevelColumns = [
  ...
  { title: '作业内容', name: 'name', width: '200px' },
...
export default {
  ...
  components: {
    ...
    DataTable,
    // RiskAssessmentForm,
    RealTimeRiskAssessmentSecondItemForm,
    RealTimeRiskAssessmentThirdItemForm,
    RealTimeRiskThirdItemCaseForm,
    RealTimeRiskAssessmentThirdItemDetail,
    RealTimeRiskAssessmentThirdItemStandardDetail
  },
  ...
  computed: {
    ...
    thirdItemStandardDetail () {
      return this.$refs.thirdItemStandardDetail
    },
