        ...
        <ul>
          <li>
            <div class="li-item-first">
              <div class="li-item-content" style="width:100%;justify-content: center">企业合规性</div>
            </div>
            <div>
              <div
          ...
          <li>
            <div class="li-item-first">
              <div class="li-item-name">证书类型</div>
              <div class="li-item-content"><p>{{thirdItemDetail.resultIn}}</p></div>
            </div>
            <div>
          ...
          <li class="li-height-2">
            ...
            <div class="li-item-content"><p>{{thirdItemDetail.identifyEvaluationStandard}}</p></div>
          </li>
          ...
          <li>
            <div class="li-item-first">
              ...
              <div class="li-item-content"><p>{{thirdItemDetail.projectTechnology}}</p></div>
            </div>
            <div>
              <div class="li-item-name">培训教育</div>
              <div class="li-item-content"><p>{{thirdItemDetail.managementMeasure}}</p></div>
            </div>
          </li>
          <li>
            <div class="li-item-name">管理措施</div>
            <div class="li-item-content"><p>{{controlDesc(thirdItemDetail.controlMeans)}}</p></div>
          </li>
          <li class="li-height-3">
            <div class="li-item-name">证书详情</div>
            <div class="li-item-content"><p>{{controlDesc(thirdItemDetail.controlMeans)}}</p></div>
          </li>
        </ul>
      </div>
