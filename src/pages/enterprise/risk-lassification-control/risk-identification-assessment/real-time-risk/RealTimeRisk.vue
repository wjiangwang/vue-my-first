      ...
      <div class="enterprise-risk-assessments">
        ...
        >
          ...
          <div slot="actions" slot-scope="{ row }" class="table-actions">
            ...
            <el-button type="text" size="medium" @click="taskHistory.show(row.id)">历史记录</el-button>
            <el-button
              type="text"
              size="medium"
...
import RiskAssessmentForm from './RealTimeRiskAssessmentForm'
...
export default {
  ...
  methods: {
    ...
    handleType (id) {
      this.$router.push({ path: id + '/realTime/items' })
    },
