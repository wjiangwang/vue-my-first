...
const tableColumns = [
  { title: '作业时间', name: 'createDate', type: 'date' ,width: '130px'},
  { title: '作业地点', name: 'riskName' },
  { title: '作业类型', name: 'twoName',width: '100px' },
  { title: '作业岗位', name: 'structureName',width: '100px' },
  { title: '发起作业人员', name: 'structureName',width: '130px' },
  { title: '完成情况', name: 'structureName',width: '120px' },
