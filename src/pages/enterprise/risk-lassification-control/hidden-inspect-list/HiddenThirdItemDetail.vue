<template>
  <div>
    <el-dialog title="三级子项详情" :visible.sync="visible" @close="clear" :close-on-click-modal="false" :lose-on-press-escape="false" class="hidden-third-dialog" :append-to-body="appendToBody">
      <div class="hidden-third-body" v-loading="loading">
        <ul>
          <li>
            <div class="li-item-first">
              <div class="li-item-name">排查区域</div>
              <div class="li-item-content">{{thirdItemDetail.riskName}}</div>
            </div>
            <div>
              <div class="li-item-name">排查项目</div>
              <div class="li-item-content">{{thirdItemDetail.twoName}}</div>
            </div>
          </li>
          <li>
            <div class="li-item-first">
              <div class="li-item-name">排查内容</div>
              <div class="li-item-content">{{thirdItemDetail.name}}</div>
            </div>
            <div>
              <div class="li-item-name">排查方式</div>
              <div class="li-item-content">{{controlPeriodDesc(thirdItemDetail.controlPeriod)}}</div>
            </div>
          </li>
          <li>
          ...
          <li>
            ...
            <div>
              <div class="li-item-name">复核岗位</div>
              <div class="li-item-content"></div>
            </div>
          </li>
          <!-- <li>
          ...
          <li>
            <div class="li-item-first">
              <div class="li-item-name">管控专业</div>
