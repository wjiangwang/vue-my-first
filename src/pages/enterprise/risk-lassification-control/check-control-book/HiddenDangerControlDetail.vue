        ...
        <ul>
          <li>
            <div class="li-item-first">
              <div class="li-item-name">隐患名称：</div>
              <div class="li-item-content">{{record.basic.hiddenDangerName}}</div>
            </div>
            <div>
              <div class="li-item-name">隐患状态：</div>
              <div class="li-item-content">{{statusText}}</div>
            </div>
          </li>
          <li>
            <div class="li-item-first" :class="['field-value level-field-value', `level-${'1'}`]">
              <div class="li-item-name">隐患级别：</div>
              <div class="li-item-content">{{levelText}}</div>
            </div>
            <div>
              <div class="li-item-name">修改日期：</div>
              <div class="li-item-content">{{record.basic.modifyDate | strftime}}</div>
            </div>
          </li>
          <li>
            <div class="li-item-first">
              <div class="li-item-name">排查时间：</div>
              <div class="li-item-content">{{record.basic.troubleshootDate | strftime}}</div>
            </div>
            <div>
              <div class="li-item-name">隐患分类：</div>
              <div class="li-item-content">{{record.basic.hiddenDangerType}}</div>
            </div>
          </li>
          <li>
            <div class="li-item-first">
              <div class="li-item-name">是否延期：</div>
              <div class="li-item-content">{{record.basic.isDelay === 1 ? '是' : '否'}}</div>
            </div>
            <div>
              <div class="li-item-name">隐患来源：</div>
              <div class="li-item-content">{{record.basic.hiddenDangerSource}}</div>
            </div>
          </li>
          <li>
            <div class="li-item-first">
              <div class="li-item-name">记录人：</div>
              <div class="li-item-content">{{record.basic.recordPersonnel}}</div>
            </div>
            <div>
              <div class="li-item-name">整改人：</div>
              <div class="li-item-content">{{record.basic.principalPersonnel}}</div>
            </div>
          </li>
          <li>
            <div class="li-item-first">
              <div class="li-item-name">隐患地点：</div>
              <div class="li-item-content">{{record.basic.hiddenDangerLocation}}</div>
            </div>
            <div>
              <div class="li-item-name">落实整改资金（元）：</div>
              <div class="li-item-content">{{record.basic.workablePrice}}</div>
            </div>
          </li>
          <li>
            <div class="li-item-first">
              <div class="li-item-name">排查人员：</div>
              <div class="li-item-content">{{record.basic.principalPersonnel}}</div>
            </div>
            <div>
              <div class="li-item-name">计划整改资金（元）：</div>
              <div class="li-item-content">{{record.basic.planPrice}}</div>
            </div>
          </li>
        </ul>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions('regionalRisk', ['loadHiddenDetail']),

      async show(id) {
        this.visible = true
        this.loading = true

        const result = await this.loadHiddenDetail(id)
        this.record = {
