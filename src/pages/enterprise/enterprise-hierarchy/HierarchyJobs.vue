<template>
  <div class="hierarchy-jobs" v-loading="jobsLoading">
    <div class="new-job-action">
      <el-button type="text" @click="showHierarchyJobNewForm" v-if="!isRedirect">
    ...
    <el-tabs type="card" :closable="true"
      ...
      <el-tab-pane v-for="job in jobs"
        ...
        <span slot="label" class="tab-label">
          ...
          {{job.name}}
          <i class="el-icon-edit" title="编辑" v-if="!isRedirect" @click.stop="showHierarchyJobEditForm(job)"></i>
        </span>
        <el-row>
          <el-col :span="12">
                ...
                <div class="columns">
                  ...
                  <div class="right">
                    <el-button type="danger"
                      ...
                      v-if="employeeList.items.length > 0 && !isRedirect">
                      一键移除
                    </el-button>
                ...
                <div class="columns">
                  ...
                  <div class="right">
                    <el-button type="danger"
                      ...
                      v-if="riskList.items.length > 0 && !isRedirect">
                      一键移除
                    </el-button>
                    <el-button type="success"
                      size="small"
    ...
    <hierarchy-job-form :hierarchy="hierarchy"
      ref="hierarchyJobForm" @updated="loadTablesData" />
